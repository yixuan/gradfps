...
gradfps_prox_ <- function(S, x0, d, lambda, lr, mu, r1, r2, maxiter = 500L, eig_spectra = TRUE, fan_maxinc = 100L, fan_maxiter = 10L, eps_abs = 1e-3, eps_rel = 1e-3, verbose = 0L) {
    .Call(`_gradfps_gradfps_prox_`, S, x0, d, lambda, lr, mu, r1, r2, maxiter, eig_spectra, fan_maxinc, fan_maxiter, eps_abs, eps_rel, verbose)
}

gradfps_prox_benchmark_ <- function(S, Pi, x0, d, lambda, lr, mu, r1, r2, maxiter = 500L, eig_spectra = TRUE, fan_maxinc = 100L, fan_maxiter = 10L, eps_abs = 1e-3, eps_rel = 1e-3, verbose = 0L) {
    .Call(`_gradfps_gradfps_prox_benchmark_`, S, Pi, x0, d, lambda, lr, mu, r1, r2, maxiter, eig_spectra, fan_maxinc, fan_maxiter, eps_abs, eps_rel, verbose)
}

gradfps_prox_omd_ <- function(S, x0, d, lambda, delta, lr, mu, r1, r2, maxiter = 500L, eig_spectra = TRUE, fan_maxinc = 100L, fan_maxiter = 10L, eps_abs = 1e-3, eps_rel = 1e-3, verbose = 0L) {
    .Call(`_gradfps_gradfps_prox_omd_`, S, x0, d, lambda, delta, lr, mu, r1, r2, maxiter, eig_spectra, fan_maxinc, fan_maxiter, eps_abs, eps_rel, verbose)
}
